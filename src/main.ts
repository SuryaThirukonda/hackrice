...
function start(): void {
  ...
  const game = new Phaser.Game({
    ...
    scene: [BootScene, TitleScene, MainMenuScene, TempoSessionScene, ReadyUpScene, BaselineScene, RecoveryScene, SessionSummaryScene, ModeSelectScene, GameSelectScene, PlaceholderScene, CreditsScene, BoxingScene, TutorialScene, PreFightScene, SettingsScene, FightNightScene, BowlingScene, GolfScene, ControllerScene, HealthScene, CursorTrail],
  })
