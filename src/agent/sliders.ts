...
export interface GameSettings { preset: Preset; difficulty: Difficulty; seed: number | null; sound: boolean; quality: Quality; bindings: Record<string, Record<string, string[]>>; weightKg: number | null; weightUnit: 'kg' | 'lb'; dailyGoalMinutes: number; dailyGoalKcal: number }
const KEY = 'hap.v2.settings'
const defaultQuality = (): Quality => 'medium'
export const DEFAULT_SETTINGS: GameSettings = { preset: 'rookie', difficulty: { ...PRESETS.rookie }, seed: null, sound: true, quality: defaultQuality(), bindings: {}, weightKg: null, weightUnit: 'kg', dailyGoalMinutes: 30, dailyGoalKcal: 100 }
