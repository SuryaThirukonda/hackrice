...
export function boxingParams(d: Difficulty): BotParams {
  ...
  return {
    ...
    aggression: lerp(0.3, 0.95, d.aggression),
    comboGap: Math.round(lerp(24, 9, d.aggression)),
...
const defaultQuality = (): Quality => 'medium' // high (SSAO, 2K shadows, native DPR) is opt-in from Settings
