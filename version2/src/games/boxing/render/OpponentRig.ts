...
export class OpponentRig {
  ...
  constructor(parent: Entity, color = P.red, trunks = P.blue, device?: import('playcanvas').GraphicsDevice) {
    ...
    for (const s of [-1, 1]) {
      ...
      part(hip, 'thigh', 'cylinder', skin, { pos: { x: 0, y: -0.23, z: 0 }, scale: { x: 0.16, y: 0.44, z: 0.16 } })
      part(hip, 'knee', 'sphere', skin, { pos: { x: 0, y: -0.45, z: 0 }, scale: { x: 0.17, y: 0.17, z: 0.17 } })
    ...
    part(this.body, 'shoulders', 'box', skin, { pos: { x: 0, y: 1.46, z: 0 }, scale: { x: 0.68, y: 0.14, z: 0.26 } })
    part(this.body, 'neck', 'cylinder', skin, { pos: { x: 0, y: 1.57, z: 0 }, scale: { x: 0.13, y: 0.12, z: 0.13 } })
    ...
    part(this.head, 'eyeL', 'sphere', flatMat(0x141414), { pos: { x: -0.07, y: 0.17, z: -0.15 }, scale: { x: 0.05, y: 0.05, z: 0.03 }, outline: false })
    part(this.head, 'eyeR', 'sphere', flatMat(0x141414), { pos: { x: 0.07, y: 0.17, z: -0.15 }, scale: { x: 0.05, y: 0.05, z: 0.03 }, outline: false })
    ...
    const mk = (n: string): [Entity, Entity, Entity, Entity] => [
      part(this.body, n + 'Upper', 'cylinder', skin, { scale: { x: 0.12, y: L1, z: 0.12 } }),
      part(this.body, n + 'Fore', 'cylinder', skin, { scale: { x: 0.1, y: L2, z: 0.1 } }),
      part(this.body, n + 'Glove', 'sphere', glove, { scale: { x: 0.22, y: 0.2, z: 0.24 } }),
      part(this.body, n + 'Elbow', 'sphere', skin, { scale: { x: 0.13, y: 0.13, z: 0.13 } }),
    ]
