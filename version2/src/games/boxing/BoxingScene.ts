...
/** First-person 3D boxing: Phaser owns input, the fixed-step sim, the HUD and the frame; PlayCanvas renders behind it. */
export class BoxingScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    void Engine3D.get().then((e) => {
      ...
      this.world = new BoxingWorld(e, P.red, this.card)
