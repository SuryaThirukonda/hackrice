...
export const CONTROLLER_CONFIG = {
  ...
  detectors: {
    boxing: {
      ...
      armResetRotation: 0,
      armTimeoutMs: 0,
      releaseAcceleration: 3.8,
      releasePeakRatio: 0.48,
      rearmAcceleration: 5.5,
      minDurationMs: 34,
      maxDurationMs: 260,
      cooldownMs: 180,
      powerAccelerationMax: 36,
      powerRotationMax: 600,
      accelerationWeight: 0.78,
      rotationWeight: 0.22,
      powerCurveExponent: 1.35,
    ...
    golf: {
      ...
      maxDurationMs: 520,
      cooldownMs: 260,
      powerAccelerationMax: 38,
      powerRotationMax: 700,
